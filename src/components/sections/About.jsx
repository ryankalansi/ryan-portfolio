        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              ...
              and a growing passion for Project Management. I enjoy turning
              ideas into responsive, engaging products while ensuring
              collaboration, clarity, and impact throughout the process.
            </p>
